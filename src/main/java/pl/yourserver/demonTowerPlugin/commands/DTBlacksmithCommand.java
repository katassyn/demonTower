...
/**
 * Opens Corrupted Blacksmith GUI (Floor 1 mechanic)
 * Can be used for testing outside of DT session
 */
public class DTBlacksmithCommand implements CommandExecutor {

    private final DemonTowerPlugin plugin;

    public DTBlacksmithCommand(DemonTowerPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command,
        ...
        if (!player.hasPermission("demontower.mechanic.blacksmith")) {
