...
/**
 * Opens Infernal Crucible GUI (Floor 4 mechanic)
 * Can be used for testing outside of DT session
 */
public class DTCrucibleCommand implements CommandExecutor {

    private final DemonTowerPlugin plugin;

    public DTCrucibleCommand(DemonTowerPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command,
        ...
        if (!player.hasPermission("demontower.mechanic.crucible")) {
